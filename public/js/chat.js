...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#chatArea .open-chat').on('click',()=>{
            $('#chatArea .chat-container').fadeIn(700);
            $('#chatArea .chat-main').fadeIn(700);
            $('#chatArea .open-chat').hide();
        });

        $('#chatArea .close-chat').on('click',()=>{
            $('#chatArea .chat-container').fadeOut(700);
            $('#chatArea .chat-main').fadeOut(700);
            setTimeout(() => {
                $('#chatArea .open-chat').show();
            }, 701);
        });
